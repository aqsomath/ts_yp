...
@dp.callback_query_handler(taxi_pochta_callback.filter(item_name='raz'))
async def reys(call:CallbackQuery,state:FSMContext):
    ...
    await call.message.answer("Yukni qaysi tumandan olasiz ? ",reply_markup=andijon_yol)
...
@dp.callback_query_handler(text='ortga',state=Reys_pochta_andijon.viloyatga)
async def andi_jon(call:CallbackQuery,state:FSMContext):
    await call.message.answer("Qaysi tumanidan ketasiz ? ", reply_markup=andijon_yol)#############
    await Reys_pochta_andijon.tuman.set()
...
@dp.message_handler(state=Reys_pochta_andijon.kuni)
...
@dp.callback_query_handler(text='ortga',state=Reys_pochta_andijon.phone)
async def andi_jon(call:CallbackQuery,state:FSMContext):
...
@dp.message_handler(state=Reys_pochta_andijon.xa_yoq)
...
@dp.message_handler(state=Reys_pochta_andijon.pochta_olasizmi)
...
@dp.message_handler(state=Reys_pochta_andijon.yuk_olasizmi)
...
@dp.message_handler(state=Reys_pochta_andijon.jami_odam)
async def jami_odam(message:Message,state:FSMContext):
    ...
    await Reys_pochta_andijon.odam.set()

@dp.message_handler(state=Reys_pochta_andijon.odam)
