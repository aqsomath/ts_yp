...
@dp.callback_query_handler(taxi_sayohat_callback.filter(item_name='dod'))
async def reys(call: CallbackQuery, state: FSMContext):
    ...
    await call.message.answer("Sayohatchilarni qaysi tumandan olasiz ? ", reply_markup=jizzax_yol)
