...
@dp.callback_query_handler(state=Reys_andijon.asosiy)
async def andijon_taxi(call: CallbackQuery, state: FSMContext):
...
async def andi_jon_taxi(call: CallbackQuery, state: FSMContext):
...
async def haydovchi_taxi(call: CallbackQuery, state: FSMContext):
...
async def reys_tuman_taxi(call: CallbackQuery, state: FSMContext):
        ...
        await call.message.delete()
        await Reys_andijon.viloyatga.set()


@dp.callback_query_handler(text='homeback', state=Reys_andijon.viloyatga)
async def andi_jon__taxi(call: CallbackQuery, state: FSMContext):
...
async def reys_viloyatga_taxi(call: CallbackQuery, state: FSMContext):
        ...
        await call.message.delete()
        await Reys_andijon.tumaniga.set()

@dp.callback_query_handler(text='ortga', state=Reys_andijon.tumaniga)
async def andi_jon_taaxi(call: CallbackQuery, state: FSMContext):
...
async def haydovchi_taaxi(call: CallbackQuery, state: FSMContext):
...
async def reys_tumaniga_taxii(call: CallbackQuery, state: FSMContext):
        ...
        await call.message.delete()
        await Reys_andijon.kuni.set()


@dp.callback_query_handler(text="ortga", state=Reys_andijon.kuni)
async def taqas_taxi(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text="atmen", state=Reys_andijon.kuni)
async def taqas__taxi(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text='Qoldakiritish', state=Reys_andijon.kuni)
async def qolda_yozing_taxi(call: CallbackQuery, state: FSMContext):
        ...
        await call.message.delete()
        await Reys_andijon.oyini_kiritsh.set()


@dp.callback_query_handler(text="boshmenu", state=Reys_andijon.oyini_kiritsh)
async def bosh_taxi(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text="Ortga", state=Reys_andijon.oyini_kiritsh)
async def qayyt_taxi(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(state=Reys_andijon.oyini_kiritsh)
async def oyi_taxi(call: CallbackQuery, state: FSMContext):
        ...
        await call.message.delete()
        await Reys_andijon.kunini_kiritsh.set()


@dp.callback_query_handler(text="boshmenu", state=Reys_andijon.kunini_kiritsh)
async def boshaa_taxi(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text="Ortga", state=Reys_andijon.kunini_kiritsh)
async def qayy_taxi(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(state=Reys_andijon.kunini_kiritsh)
async def kunini_taxi(call: CallbackQuery, state: FSMContext):
    
        await state.update_data({"sanasi": call.data})
        await call.message.answer("Soat nechchida yo'lga chiqasiz ? ", reply_markup=time)
        await call.message.delete()
        await Reys_andijon.soat.set()


@dp.callback_query_handler(text='Bugun', state=Reys_andijon.kuni)
@dp.callback_query_handler(text='Ertaga', state=Reys_andijon.kuni)
@dp.callback_query_handler(text='Indinga', state=Reys_andijon.kuni)
async def oy_taxi(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text='qaytish', state=Reys_andijon.aniq_kuni)
async def aniq_ku_taxi(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text='bomenyu', state=Reys_andijon.aniq_kuni)
async def menu_bosh_taxi(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text='ortga', state=Reys_andijon.kuni)
async def taxi_andi_jon(call: CallbackQuery, state: FSMContext):
    
        await call.message.answer("Qaysi viloyatga yo'lovchi olib borasiz ? ", reply_markup=viloyatlar_yol_x)
        await call.message.delete()
        await Reys_andijon.viloyatga.set()

@dp.callback_query_handler(text_contains='atmen', state=Reys_andijon.kuni)
async def taxi_haydovchi(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(state=Reys_andijon.aniq_kuni)
async def taxi_reys_kuni(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text='ortga', state=Reys_andijon.soat)
async def taxi__andi_jon(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text_contains='atmen', state=Reys_andijon.soat)
async def ta_1haydovchi(call: CallbackQuery, state: FSMContext):
...
async def taxi_reys_soat(call: CallbackQuery, state: FSMContext):
        ...
        await call.message.delete()
        await Reys_andijon.phone.set()


@dp.callback_query_handler(text='tortga', state=Reys_andijon.phone)
async def tax_andi_jon(call: CallbackQuery, state: FSMContext):
...
async def t_haydovchi(call: CallbackQuery, state: FSMContext):
...
async def taxireys_loc(message: Message, state: FSMContext):
        ...
        if oy is not None:
            m = f"🚕\n<b> 🏢 {viloyat} </b>\n" \
                f"🏤 <b>{tuman}dan </b> \n" \
                f"🏢 <b>{viloyatiga} \n" \
                f"🏪 <b>{tumaniga} ga boruvchi taxi</b>\n" \
...
@dp.callback_query_handler(text='yesss', state=Reys_andijon.tasdiqlash)
async def taxiy_n(call: CallbackQuery, state: FSMContext):
...
async def y_taxin(call: CallbackQuery, state: FSMContext):
...
async def ysdsd_n(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text="ortga", state=Reys_andijon.xa_yoq)
async def taxi_qaytaman(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text="boshmenu", state=Reys_andijon.xa_yoq)
async def qaytaman_taxi(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text="qoldayozish", state=Reys_andijon.xa_yoq)
async def taxi_qlda_yoz(call: CallbackQuery, state: FSMContext):
        ...
        await call.message.delete()
        await Reys_andijon.qolda_yoz.set()

@dp.callback_query_handler(text="Keyingisi", state=Reys_andijon.xa_yoq)
async def taxijeieir(call: CallbackQuery, state: FSMContext):
        ...
        await call.message.delete()
        await Reys_andijon.pochta_olasizmi.set()


@dp.callback_query_handler(text="boshmenu", state=Reys_andijon.qolda_yoz)
async def taxi_rebmenu(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text="ortga", state=Reys_andijon.qolda_yoz)
async def taxi_qol(call: CallbackQuery, state: FSMContext):
...
@dp.message_handler(state=Reys_andijon.qolda_yoz)
async def kisi_taxi(message: Message, state: FSMContext):
...
@dp.callback_query_handler(state=Reys_andijon.xa_yoq)
async def takkisi(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text="ortga", state=Reys_andijon.pochta_olasizmi)
async def taksi_sdljf(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text="boshmenu", state=Reys_andijon.pochta_olasizmi)
async def taksi_skahh(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text="Keyingisi", state=Reys_andijon.pochta_olasizmi)
async def taksi_reys_pochta_olasizmi(call: CallbackQuery, state: FSMContext):
        ...
        await call.message.delete()
        await Reys_andijon.yuk_olasizmi.set()


@dp.callback_query_handler(state=Reys_andijon.pochta_olasizmi)
async def reys_pochta_olasizmi_taksi(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text="ortga", state=Reys_andijon.yuk_olasizmi)
async def taxi_kasla(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text="boshmenu", state=Reys_andijon.yuk_olasizmi)
async def taxi_jasa(call: CallbackQuery, state: FSMContext):
    
        await call.message.answer("Salom haydovchi\nSizga kerakli hizmat turini belgilang ?", reply_markup=umumiy_menu_1)
        await call.message.delete()
        await state.finish()

@dp.callback_query_handler(text="Keyingisi", state=Reys_andijon.yuk_olasizmi)
async def taxi_yuk_olasizmi_reys(call: CallbackQuery, state: FSMContext):
        ...
        await call.message.delete()
        await Reys_andijon.jami_odam.set()

@dp.callback_query_handler(state=Reys_andijon.yuk_olasizmi)
async def taxi_olasizmi_reys(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text="qoldayozish",state=Reys_andijon.jami_odam)
async def qolda_kiritish_taksi(call:CallbackQuery,state:FSMContext):
    
        await call.message.answer("Nechta yo'lovchi olishingizni yozma kiriting .")
        await call.message.delete()
        await Reys_andijon.qolda_odam_soni.set()

@dp.message_handler(state=Reys_andijon.qolda_odam_soni)
async def qolda_odam_soni_taksi(message:Message,state:FSMContext):
        ...
        if message.text.isdigit()==True:
            ...
            await message.delete()
            await Reys_andijon.locatsiya.set()
        else:
            await message.answer("Iltimos son kiritib ifodalang. Matn bilan emas !!!")
            await Reys_andijon.qolda_odam_soni.set()

@dp.callback_query_handler(text="ortga", state=Reys_andijon.jami_odam)
async def taxiiksdhkja(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text="boshmenu", state=Reys_andijon.jami_odam)
async def alaskjaskjs(call: CallbackQuery, state: FSMContext):
    
        await call.message.answer("Salom haydovchi\nSizga kerakli hizmat turini belgilang ?", reply_markup=umumiy_menu_1)
        await call.message.delete()
        await state.finish()

@dp.callback_query_handler(text="Keyingisi",state=Reys_andijon.jami_odam)
async def ton_taxi(call:CallbackQuery,state:FSMContext):
...
@dp.callback_query_handler(state=Reys_andijon.jami_odam)
async def taksi_ton(call:CallbackQuery,state:FSMContext):
...
@dp.callback_query_handler(text="boshmenu", state=Reys_andijon.locatsiya)
async def bosh_menu_taksi(call:CallbackQuery,state:FSMContext):
    
        await call.message.answer("Salom haydovchi\nSizga kerakli hizmat turini belgilang ?", reply_markup=umumiy_menu_1)
        await call.message.delete()
        await state.finish()

@dp.callback_query_handler(text="ortga", state=Reys_andijon.locatsiya)
async def ortga_qaytamian_tas(call:CallbackQuery,state:FSMContext):
...
@dp.callback_query_handler(text="ruchnoy", state=Reys_andijon.locatsiya)
async def pol_ruchnoy_taxi(call: CallbackQuery, state: FSMContext):
        ...
        await call.message.delete()
        await Reys_andijon.pul_qol.set()

@dp.message_handler(state=Reys_andijon.pul_qol)
async def qolda_pul(message: Message, state: FSMContext):
            ...
            await message.answer("Yo'lingizdagi qaysi tumanlardan qo'shimcha yo'lovchi olasiz ? ",
                                 reply_markup=viloyatlar_yol)
            await message.delete()
            await Reys_andijon.odam_vil.set()
@dp.callback_query_handler(text="Keyingisi", state=Reys_andijon.locatsiya)
async def jami_odam(call: CallbackQuery, state: FSMContext):
        ...
        await call.message.delete()
        await Reys_andijon.odam_vil.set()
@dp.callback_query_handler(state=Reys_andijon.locatsiya)
async def jami_odam(call: CallbackQuery, state: FSMContext):
        ...
        await call.message.delete()
        await Reys_andijon.odam_vil.set()
@dp.callback_query_handler(text="ortga", state=Reys_andijon.odam_vil)
...
@dp.callback_query_handler(text="boshmenu", state=Reys_andijon.odam_vil)
...
@dp.callback_query_handler(state=Reys_andijon.odam_vil)
async def odam_viloyat(call: CallbackQuery, state: FSMContext):
        ...
        if call.data == 'andijon':
            ...
            await call.message.answer("Andijonning qaysi tumanlaridan yo'lovchi olasiz ?", reply_markup=shaxsiy_tugma)
        ...
        if call.data == 'namangan':
            ...
            await call.message.answer("Namanganning qaysi tumanlaridan yo'lovchi olasiz ?", reply_markup=shaxsiy_namangan)
            await Reys_andijon.tuman_yol.set()
            await call.message.delete()
        ...
        if call.data == "farg'ona":
            ...
            await call.message.answer("Farg'onaning qaysi tumanlaridan yo'lovchi olasiz ?", reply_markup=shaxsiy_fargona)
            await Reys_andijon.tuman_yol.set()
            await call.message.delete()
        ...
        if call.data == 'buxoro':
            ...
            await call.message.answer("Buxoroning qaysi tumanlaridan yo'lovchi olasiz ?", reply_markup=shaxsiy_buxoro)
            await Reys_andijon.tuman_yol.set()
            await call.message.delete()
        ...
        if call.data == 'toshkent':
            ...
            await call.message.answer("Toshkentning qaysi tumanlaridan yo'lovchi olasiz ?", reply_markup=shaxsiy_toshkent)
            await Reys_andijon.tuman_yol.set()
            await call.message.delete()
        ...
        if call.data == 'sirdaryo':
            ...
            await call.message.answer("Sirdaryoning qaysi tumanlaridan yo'lovchi olasiz ?", reply_markup=shaxsiy_sirdaryo)
            await Reys_andijon.tuman_yol.set()
            await call.message.delete()
        ...
        if call.data == 'surxondaryo':
            ...
            await call.message.answer("Surxondaryoning qaysi tumanlaridan yo'lovchi olasiz ?",
        ...
        if call.data == 'qashqadaryo':
            ...
            await call.message.answer("Qashqadaryoning qaysi tumanlaridan yo'lovchi olasiz ?",
        ...
        if call.data == 'xorazm':
            ...
            await call.message.answer("Xorazmning qaysi tumanlaridan yo'lovchi olasiz ?", reply_markup=shaxsiy_xorazm)
            await Reys_andijon.tuman_yol.set()
            await call.message.delete()
        ...
        if call.data == 'navoiy':
            ...
            await call.message.answer("Navoiyning qaysi tumanlaridan yo'lovchi olasiz ?", reply_markup=shaxsiy_navoiy)
            await Reys_andijon.tuman_yol.set()
            await call.message.delete()
        ...
        if call.data == 'jizzax':
            ...
            await call.message.answer("JIzzaxning qaysi tumanlaridan yo'lovchi olasiz ?", reply_markup=shaxsiy_jizzax)
            await Reys_andijon.tuman_yol.set()
            await call.message.delete()
        ...
        if call.data == 'samarqand':
            ...
            await call.message.answer("Samarqandning qaysi tumanlaridan yo'lovchi olasiz ?",
        ...
        if call.data == 'kent shahar':
            ...
            await call.message.answer("tosh_shaharning qaysi tumanlaridan yo'lovchi olasiz ?", reply_markup=shaxsiy_tosh_shahar)
            await Reys_andijon.tuman_yol.set()
            await call.message.delete()
        ...
        if call.data == 'qoraqalpoq':
            ...
            await call.message.answer("qoraqalpoqning qaysi tumanlaridan yo'lovchi olasiz ?", reply_markup=shaxsiy_qoraqalpoq)
            await Reys_andijon.tuman_yol.set()
            await call.message.delete()
        ...
        if call.data == 'tanladim':
            ...
            await call.message.delete()
            await Reys_andijon.end.set()
@dp.callback_query_handler(text='boshmenu', state=Reys_andijon.end)
async def boshmenuga(call: CallbackQuery, state: FSMContext):
    
        await call.message.answer("Ma'lumotlarni tog'rilab qaytadan kiriting", reply_markup=umumiy_menu_1)
        await call.message.delete()
        await state.finish()
@dp.callback_query_handler(text='qaytish', state=Reys_andijon.end)
...
@dp.callback_query_handler(text='glavmenu', state=Reys_andijon.end)
async def boshmenuga(call: CallbackQuery, state: FSMContext):
    
        await call.message.answer("Ma'lumotlarni tog'rilab qaytadan kiriting", reply_markup=umumiy_menu_1)
        await call.message.delete()
        await state.finish()
@dp.callback_query_handler(text='Confirm', state=Reys_andijon.end)
async def oxirgisdsd(call: CallbackQuery, state: FSMContext):
...
@dp.callback_query_handler(text='UnConfirm', state=Reys_andijon.end)
async def adsddsee(call: CallbackQuery, state: FSMContext):
